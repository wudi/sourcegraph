...
const SiteSchemaJSON = `{
  ...
  "properties": {
    ...
    "permissions.userMapping": {
      "description": "Settings for Sourcegraph permissions, which allow the site admin to explicitly manage repository permissions via GraphQL APIs. This setting cannot be enabled when any other code host authorization provider is in use.",
      "type": "object",
      "additionalProperties": false,
      "properties": {
        "enabled": {
          "description": "Whether permissions user mapping is enabled. All of authorization providers configured in the external services must be disabled before enabling this.",
          "type": "boolean",
          "default": false
        },
        "bindID": {
